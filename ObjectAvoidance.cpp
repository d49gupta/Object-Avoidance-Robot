...
Servo servo; //Creating abject from the servo library

NewPing sonar(TRIGGER_PIN, ECHO_PIN, max_distance);
//Creating an object from the NewPing Library
...
void objectAvoid() {
  ...
  if (distance <= 15) {
    ...
    //Ultrasonic sensor being able to move left and right due to servo motor
    lookLeft();
    lookRight();
    delay(100);
...
int lookRight() {
  //lock right
  servo.write(30); //parameter is angle
  delay(500);
